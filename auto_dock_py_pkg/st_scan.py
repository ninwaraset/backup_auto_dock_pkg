...
##########################################################################################################################################################################      
        ...
        def lidar_DBscan(x_list,y_list,eps_value=0.05,min_samples_value=5,show_plot = 1):
            print("\n++ DB SCAN ++")
            lidar_list = []
        ...
        def set_sub_goal(x_list,y_list,cluster_dict,label_charger,idx_vtx_tri,radius_vertex = 0.18,distance_blue= 0.8):
            print("\n++ SET SUB GOAL ++")
